...
graph $G$, whose set of edges $E$ is composed by all the connections between pairs of nodes one in reach of the other. Consider the following as a simplified
