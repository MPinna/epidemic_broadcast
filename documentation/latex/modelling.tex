...
value of the geometric distribution, $\frac{1 - p}{p}$, times the number of hops needed
...
center node. Now there is the possibility of collisions and a non-zero
probability that there will never be total coverage. To simplify the analysis of
this system and obtain some more insight, it is useful to model it by means of a
