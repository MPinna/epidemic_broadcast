...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.42}{\input{img/Big_CovP_median.pgf} }
    \end{center}
    \vspace*{-1cm}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.9}{\input{img/Big_CovRange_mean.pgf}}
    \end{center}
    \vspace*{-1cm}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.9}{\input{img/Big_DurRange_mean.pgf}}
    \end{center}
    \vspace*{-1cm}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.4}{\input{img/Big_CollP_median.pgf}}
    \end{center}
    \vspace*{-1cm}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \scalebox{0.69}{\input{img/Big_CollRange_mean.pgf}}
    \end{center}
    \vspace*{-1cm}
\end{figure}
